...
Please clone the `bootstrap_implementation` GitHub repo, and work in the `.Rmd` file contained within it.
...
When finished, make sure to knit + commit + push and submit your final PDF to Canvas!
