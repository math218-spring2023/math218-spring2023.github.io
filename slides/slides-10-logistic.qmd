...
-   We typically have more than one observation $\Rightarrow$ calculate the **classification error rate**, which is the proportion of mistakes we make in predicted labels: $$\frac{1}{n} \sum_{i=1}^{n} \mathbf{1}(y_{i} \neq \hat{y}_{i})$$
